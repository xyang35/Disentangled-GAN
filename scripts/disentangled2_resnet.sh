...
name=disentangled2_${netG}_${nonlinear}_A${lambda_A}_TV${lambda_TV}_n${n_layers}
model=disentangled2
...
python train.py --dataroot $dataroot \
    ...
    --name $name --model $model --which_model_depth aod --which_model_netG $netG --n_layers $n_layers\
