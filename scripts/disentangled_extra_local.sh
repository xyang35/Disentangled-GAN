...
name=disentangled_extra_A${lambda_A}_TV${lambda_TV}_lr${lr}_extra${lambda_extra}
...
#    --non_linearity $nonlinear --lambda_A $lambda_A --lambda_TV $lambda_TV --pooling --lambda_extra $lambda_extra \
