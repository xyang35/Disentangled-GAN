...
python train.py --dataroot $dataroot \
    ...
    --non_linearity $nonlinear --lambda_A $lambda_A --lambda_TV $lambda_TV \
...
python test.py --dataroot $dataroot \
    ...
    --name $name --model $model --which_model_depth resnet_9blocks --which_model_netG resnet_9blocks --which_model_netD multi \
    --non_linearity $nonlinear  --no_dropout --depth_reverse --resize_or_crop scale_width  --loadSize 256 \
    --dataset_mode depth --display_id 0 --phase test --how_many 500
