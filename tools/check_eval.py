...
suffix = '_dcp_radiance-refinedt'; folder = '/home/xyang/Downloads/GAN/DCP/'+name+'/' 
...
psnr_bad_names = eval1['img_names']['name'][psnr_idx[:10]]
psnr_good_names = eval1['img_names']['name'][psnr_idx[-10:]]
ssim_bad_names = eval1['img_names']['name'][ssim_idx[:10]]
ssim_good_names = eval1['img_names']['name'][ssim_idx[-10:]]
