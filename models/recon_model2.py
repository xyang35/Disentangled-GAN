...
Stage 1
    ...
    Also predcit A in this model, A is a scalar value
"""
...
class ReconModel(BaseModel):
    ...
    def set_input(self, input):
        ...
        if self.opt.depth_reverse:    # tensor is [-1, 1]
    ...
    def backward_G(self):
        ...
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_G_L1
    ...
    def get_current_visuals(self):
        ...
        depth = util.tensor2im(self.input_C)
